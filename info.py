...
API_ID = int(environ.get('API_ID', '20460783'))
API_HASH = environ.get('API_HASH', '27690d11f85c3ce6bfbb76dec19f0e50')
BOT_TOKEN = environ.get('BOT_TOKEN', '7173806009:AAH9c_9JygUrMvy7kNJLN0FZG1DEJEbE_jU')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1883095680').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1453118397').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-2131990253'))
